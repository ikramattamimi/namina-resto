    ...
    <form id="customer-form" action="{{ route('customer.order') }}" method="post">
        ...
        <div class="row mb-150">
            <div class="col-md-6 col-12 form-group">
                ...
                <input class="form-control @error('customer-name') is-invalid @enderror" id="customer-name"
                    name="customer-name" type="text" value="{{ old('customer-name') ?? ($customerName ?? '') }}"
            ...
            <div class="col-md-6 col-12 form-group">
                ...
                <input class="form-control @error('customer-phone') is-invalid @enderror w-100" id="customer-phone"
                    name="customer-phone" type="number" value="{{ old('customer-phone') ?? ($customerPhone ?? '') }}"
            ...
            <div class="col-md-6 col-12 form-group">
                ...
                <input class="form-control @error('customer-table') is-invalid @enderror w-100" id="customer-table"
                    name="customer-table" type="number" value="{{ old('customer-table') ?? ($customerTable ?? '') }}"
            ...
            <div class="col-12 mb-5 form-group">
                ...
                <textarea class="form-control @error('customer-message') is-invalid @enderror" id="customer-message"
                    ...
                    placeholder="Tambahkan pesan atau catatan khusus untuk pembelian">{{ old('customer-message') }}</textarea>
