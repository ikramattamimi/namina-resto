    ...
    <form id="customer-form" action="{{ route('customer.order') }}" method="post">
        ...
        <div class="row mb-150">
            <div class="col-md-6 col-12 form-group">
                ...
                <input class="form-control" id="customer-name" name="customer-name" type="text"
            ...
            <div class="col-md-6 col-12 form-group">
                ...
                <input class="form-control w-100" id="customer-phone" name="customer-phone" type="number"
            ...
            <div class="col-md-6 col-12 form-group">
                ...
                <input class="form-control w-100" id="customer-table" name="customer-table" type="number"
            ...
            <div class="col-12 mb-5 form-group">
                ...
                <textarea class="form-control" id="customer-message" name="customer-message" cols="30" rows="5"
