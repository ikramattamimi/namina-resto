<table class="table table-bordered" id="dataTable" cellspacing="0" width="100%">
    ...
    <tbody>
        @foreach ($pengeluaranBahanBakus as $pengeluaranBahanBaku)
        <tr>
            <td>1</td>
            <td>{{ $pengeluaranBahanBaku->bahan_baku->nama }}</td>
            <td>{{ $pengeluaranBahanBaku->jumlah }}</td>
            <td>{{ $pengeluaranBahanBaku->tanggal }}</td>
            <td>{{ $pengeluaranBahanBaku->nama_staff_gudang }}</td>
