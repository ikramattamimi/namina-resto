        ...
        <tr>
            ...
            <td>
                <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('rekening.destroy', $rekening->id) }}" method="POST">
                    ...
                    <a class="btn btn-circle btn-warning btn-sm" id="editRekening" name="editRekening" href="{{ route('rekening.edit', $rekening->id) }}" role="button">
                        <i class="fas fa-edit"></i>
                    </a>
                    <button class="btn btn-circle btn-danger btn-sm" id="hapusRekening" name="hapusRekening" href="{{ route('rekening.destroy', $rekening) }}" role="button">
